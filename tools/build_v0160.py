...
OUT_DIR = Path('MWC-Torn-Remote-Bridge-v0.16.0')
OUT = OUT_DIR / 'faction-war-coordinator.user.js'
README = OUT_DIR / 'README-v0.16.0.txt'
...
'''
rep("  function openSettings() {\n", overview + "  function openSettings() {\n")
...
'''
rep("      #${OVERLAY_ID} { --border:#454b53;", styles + "      #${OVERLAY_ID} { --border:#454b53;")
